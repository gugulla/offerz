...
public class Food extends AppCompatActivity {
  ...
  //      ArrayList<bean1> theList = get_fill();
        ...
        recyclerView = findViewById(R.id.r7);
    //    foodmanager = new Foodmanager(theList, getApplicationContext());
        ...
        recyclerView.setAdapter(foodmanager);
    }
/*
    ...
    class Foodmanager extends RecyclerView.Adapter<Foodmanager.ViewHolder> {
        List<bean1> EList;
        Context context;


        public Foodmanager(ArrayList<bean1> EList, Context context) {
            this.EList = EList;
        ...
        public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
            ...
            holder.cardView1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (position == 0) {
                        Intent i1 = new Intent(Food.this, fcard.class);
                        startActivity(i1);
                    }
                }
            });
