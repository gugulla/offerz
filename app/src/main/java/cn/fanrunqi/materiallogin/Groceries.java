...
public class Groceries extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // ArrayList<bean1> theList = get_fill();
        ...
        recyclerView = findViewById(R.id.r6);
        //groceriesmanager = new Groceriesmanager(theList, getApplicationContext());
        ...
        recyclerView.setAdapter(groceriesmanager);
    }
   ...
   /* private ArrayList<bean1> get_fill() {
    ...
    class Groceriesmanager extends RecyclerView.Adapter<Groceriesmanager.ViewHolder> {
        List<bean1> EList;
        Context context;


        public Groceriesmanager(ArrayList<bean1> EList, Context context) {
            this.EList = EList;
        ...
        public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
            ...
            holder.cardView1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (position == 0) {
                        Intent i1 = new Intent(Groceries.this, gcard.class);
                        startActivity(i1);
                    }
                }
            });
