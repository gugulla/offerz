...
public class Automobiles extends AppCompatActivity {
   ...
   Automobilesmanager automobilesmanager;
 ...
 //       automobilesmanager = new Automobilesmanager(theList, getApplicationContext());
        ...
        recyclerView.setAdapter(automobilesmanager);
    }
/*
    ...
    class Automobilesmanager extends RecyclerView.Adapter<Automobilesmanager.ViewHolder> {
        List<bean1> EList;
        Context context;


        public Automobilesmanager(ArrayList<bean1> EList, Context context) {
            this.EList = EList;
        ...
        public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
            ...
            holder.cardView1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (position == 0) {
                        Intent i1 = new Intent(Automobiles.this, acard.class);
                        startActivity(i1);
                    }
                }
            });
