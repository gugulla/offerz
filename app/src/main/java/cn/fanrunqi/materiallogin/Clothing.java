...
public class Clothing extends AppCompatActivity {
  ...
  //      ArrayList<bean1> theList = get_fill();
        ...
        recyclerView = findViewById(R.id.r5);
    //    clothingmanager = new Clothingmanager(theList, getApplicationContext());
        ...
        recyclerView.setAdapter(clothingmanager);
    }
...
/*    private ArrayList<bean1> get_fill() {
    ...
    class Clothingmanager extends RecyclerView.Adapter<Clothingmanager.ViewHolder> {
        List<bean1> EList;
        Context context;


        public Clothingmanager(ArrayList<bean1> EList, Context context) {
            this.EList = EList;
        ...
        public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
            ...
            holder.cardView1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (position == 0) {
                        Intent i1 = new Intent(Clothing.this, ccard.class);
                        startActivity(i1);
                    }
                }
            });
